                          ...
                          >
                            <div className="flex flex-col lg:flex-row gap-6">
                              ...
                              <div className="flex-1 space-y-4">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center justify-between text-sm">
                                    ...
                                    <span className="text-foreground font-medium">{application.progress}%</span>
                                  </div>
                              ...
                              <div className="flex lg:flex-col gap-2">
                                ...
                                <Button variant="outline" size="sm" className="bg-background/50 backdrop-blur border-border/50 text-destructive hover:text-destructive">
